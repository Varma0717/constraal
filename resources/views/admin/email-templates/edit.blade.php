    ...
    <div class="card-body">
        <form action="{{ route('admin.email-templates.update', $template) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('body') is-invalid @enderror" id="body" name="body" rows="12" required>{{ old('body', $template->body) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('variables') is-invalid @enderror" id="variables" name="variables" value="{{ old('variables', $template->variables) }}">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.email-templates.preview', $template) }}" class="btn btn-outline-info" target="_blank">Preview</a>
            </div>
        </form>
    </div>
</div>
