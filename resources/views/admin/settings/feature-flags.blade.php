                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input feature-toggle" type="checkbox"
                                    data-feature="{{ $flag->id }}"
                                    {{ $flag->is_enabled ? 'checked' : '' }}>
                            </div>
                        </td>
                        <td>{{ $flag->updated_at?->diffForHumans() }}</td>
                        <td>
                            <button class="btn btn-sm btn-outline-danger" onclick="deleteFeature({{ (int)$flag->id }})">
...
<div class="modal fade" id="addFeatureModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.settings.feature-flags.store') }}" method="POST">
                @csrf
