        ...
        <form action="{{ route('admin.jobs.update', $job) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="type" name="type" value="{{ old('type', $job->type) }}">
            ...
            <div class="mb-4 d-flex gap-4">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="remote" name="remote" value="1" {{ old('remote', $job->remote) ? 'checked' : '' }}>
