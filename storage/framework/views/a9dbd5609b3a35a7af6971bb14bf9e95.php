...
<?php $__env->startSection('title', 'Intelligent Systems. Seamless Living.'); ?>
...
<div class="page-hero hero-home hero-video-wrap">
    ...
    <video class="hero-video-bg" autoplay muted loop playsinline preload="auto">
        <source src="<?php echo e(asset('videos/hero.mp4')); ?>" type="video/mp4">
    </video>
    ...
    <div class="site-container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="division-card">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn btn-secondary mt-4 w-full">Industrial Inquiries</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="site-container">
        <div class="early-access-container">
            ...
            <div class="early-access-form-wrapper">
                ...
                <form method="POST" action="<?php echo e(route('subscribe')); ?>" class="early-access-form">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/wwwroot/resources/views/home.blade.php ENDPATH**/ ?>