...
<section>
    <div class="site-container">
        <div class="max-w-4xl">
            ...
            <p class="text-muted mb-8">
                By submitting a job application through our website, you confirm that all information provided is accurate and complete. We will process your application in accordance with our <a href="<?php echo e(route('privacy')); ?>" class="text-brand-600 hover:underline">Privacy Policy</a>. Submission of an application does not guarantee employment or obligate Constraal to respond.
            </p>
            ...
            <p class="text-muted mb-8">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="text-brand-600 hover:underline">Contact Page</a>
            </p>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/wwwroot/resources/views/terms.blade.php ENDPATH**/ ?>