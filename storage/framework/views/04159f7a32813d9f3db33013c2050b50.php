...
<?php $__env->startSection('title', 'Maintenance Mode'); ?>
<?php $__env->startSection('page-title', 'Maintenance Mode'); ?>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.infrastructure.toggle-maintenance')); ?>" method="POST">
                    <?php echo csrf_field(); ?>

                    <?php if(!$isMaintenanceMode): ?>
                    <div class="mb-3">
                        <label for="message" class="form-label">Maintenance Message</label>
                        <textarea class="form-control" id="message" name="message" rows="3" placeholder="The site is currently under maintenance. Please check back soon."><?php echo e($maintenanceMessage); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/wwwroot/resources/views/admin/infrastructure/maintenance.blade.php ENDPATH**/ ?>