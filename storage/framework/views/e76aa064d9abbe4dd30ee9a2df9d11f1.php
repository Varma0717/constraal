<footer class="site-footer mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-white/70">
                    ...
                    <li><a href="<?php echo e(route('appliances')); ?>" class="hover:text-white transition-colors">Appliances</a></li>
                    <li><a href="<?php echo e(route('build')); ?>" class="hover:text-white transition-colors">Build</a></li>
                    <li><a href="<?php echo e(route('technology')); ?>" class="hover:text-white transition-colors">Technology</a></li>
                    <li><a href="<?php echo e(route('company')); ?>" class="hover:text-white transition-colors">Company</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-white/70">
                    ...
                    <li><a href="<?php echo e(route('terms')); ?>" class="hover:text-white transition-colors">Terms of Service</a></li>
                </ul>
            </div>
    ...
    <div class="border-t border-white/10 py-6">
        <div class="site-container text-sm text-white/60">
            &copy; <?php echo e(date('Y')); ?> Constraal. All rights reserved.
        </div>
    </div>
</footer><?php /**PATH /home/site/wwwroot/resources/views/partials/footer.blade.php ENDPATH**/ ?>