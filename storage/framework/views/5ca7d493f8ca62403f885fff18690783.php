...
<?php $__env->startSection('title', 'Create Billing Plan'); ?>
<?php $__env->startSection('page-title', 'Create Billing Plan'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.billing.plans.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select <?php $__errorArgs = ['billing_period'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="billing_period" name="billing_period" required>
                        <option value="monthly" <?php echo e(old('billing_period') == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                        <option value="annual" <?php echo e(old('billing_period') == 'annual' ? 'selected' : ''); ?>>Annual</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>" id="features" name="features" rows="4" placeholder='["Feature 1", "Feature 2"]'><?php echo e(old('features')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.billing.plans')); ?>" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/site/wwwroot/resources/views/admin/billing/create-plan.blade.php ENDPATH**/ ?>